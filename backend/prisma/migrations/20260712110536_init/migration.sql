/*
  ...
  - You are about to drop the column `consistency` on the `MonkeytypeResult` table. All the data in the column will be lost.
  - You are about to drop the column `language` on the `MonkeytypeResult` table. All the data in the column will be lost.
